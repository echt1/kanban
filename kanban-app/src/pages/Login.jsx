...
const styles = {
  wrap: {
    ...
    background: 'radial-gradient(circle at 30% 20%, rgba(76,107,138,0.15), transparent 45%), var(--ink-900)',
    padding: 20,
  },
  card: {
    width: '100%', maxWidth: 380, background: 'var(--ink-800)', border: '1px solid var(--line)',
